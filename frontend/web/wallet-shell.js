(function () {
  ...
  const I18N_DICTIONARY = {
    en: {
      ...
      app_services: "Convenient services in the app",
      credits: "Credits",
      credits_desc: "Apply for a loan online",
      deposit: "Deposit",
      deposit_desc: "Open a deposit account",
      tickets: "Tickets",
      tickets_desc: "Buy tickets and passes",
      cashback: "Cashback",
      cashback_desc: "Get rewards on purchases",
      exchange: "Exchange",
      exchange_desc: "Currency exchange rates",
      call_bank: "Call to the bank",
      bank_appointment: "Bank appointment consultation",
      personal_info: "Personal information",
      payments_hub: "Payments",
      pay_desc: "Create payment & checkout",
      autopay_desc: "USSD push & auto receipt",
    },
    sw: {
      welcome: "Karibu",
      ...
      app_services: "Huduma rahisi kwenye app",
      credits: "Mikopo",
      credits_desc: "Omba mkopo mtandaoni",
      deposit: "Amana",
      deposit_desc: "Fungua akaunti ya amana",
      tickets: "Tiketi",
      tickets_desc: "Nunua tiketi na kadi",
      cashback: "Rudishiwa pesa",
      cashback_desc: "Pata zawadi kwa manunuzi",
      exchange: "Ubadilishaji",
      exchange_desc: "Viwango vya kubadilisha fedha",
      call_bank: "Piga simu benki",
      bank_appointment: "Miadi ya ushauri benki",
      personal_info: "Taarifa za kibinafsi",
      payments_hub: "Malipo",
      pay_desc: "Tengeneza malipo na checkout",
      autopay_desc: "USSD push na risiti otomatiki",
    },
  };
