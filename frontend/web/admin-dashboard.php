...
?>
    ...
    <nav class="top-navigation" aria-label="Admin top navigation">
      ...
      <div class="top-links app-links">
        ...
        <button type="button" data-ad-target="monitoring-overview"><i class="fa-solid fa-desktop"></i> Monitoring</button>
    ...
    <aside class="ad-sidebar" id="ad-sidebar">
      ...
      <nav class="ad-sidebar-nav sidebar-menu" aria-label="Admin modules">
        ...
        <button type="button" class="ad-sidebar-link" data-ad-target="monitoring-overview">
          <i class="fa-solid fa-gauge-high ad-nav-ico"></i>
          <span class="ad-sidebar-text">Overview</span>
          <i class="fa-solid fa-chevron-right ad-sidebar-chevron" aria-hidden="true"></i>
        </button>
        ...
        <button type="button" class="ad-sidebar-link" data-ad-target="monitoring-searches">
          <i class="fa-solid fa-magnifying-glass ad-nav-ico"></i>
          <span class="ad-sidebar-text">Search Monitoring</span>
          <i class="fa-solid fa-chevron-right ad-sidebar-chevron" aria-hidden="true"></i>
        </button>
        <button type="button" class="ad-sidebar-link" data-ad-target="monitoring-downloads">
          <i class="fa-solid fa-download ad-nav-ico"></i>
          <span class="ad-sidebar-text">Downloads</span>
          <i class="fa-solid fa-chevron-right ad-sidebar-chevron" aria-hidden="true"></i>
        </button>
        <button type="button" class="ad-sidebar-link" data-ad-target="monitoring-control">
          <i class="fa-solid fa-sliders ad-nav-ico"></i>
          <span class="ad-sidebar-text">System Control</span>
          <i class="fa-solid fa-chevron-right ad-sidebar-chevron" aria-hidden="true"></i>
        </button>
        <button type="button" class="ad-sidebar-link" data-ad-target="monitoring-sms">
          <i class="fa-solid fa-comment-sms ad-nav-ico"></i>
          <span class="ad-sidebar-text">SMS Alerts</span>
          <i class="fa-solid fa-chevron-right ad-sidebar-chevron" aria-hidden="true"></i>
        </button>
      ...
      <form id="ad-mon-detail-form" class="ad-form ad-mon-detail-form" autocomplete="off">
        ...
        <div class="ad-mon-detail-grid">
          ...
          <label>Daily download limit
            <input type="number" name="daily_download_limit" id="ad-mon-detail-dlimit" min="0" step="1" placeholder="20" />
          </label>
          <label>Control mode
            <select name="control_mode" id="ad-mon-detail-control">
              <option value="active">active</option>
              <option value="read_only">read_only</option>
              <option value="api_blocked">api_blocked</option>
              <option value="fully_blocked">fully_blocked</option>
            </select>
          </label>
          <label class="ad-mon-check">
            <input type="checkbox" name="sms_alerts_enabled" id="ad-mon-detail-sms" />
            SMS alerts
          </label>
          <label class="ad-mon-check">
        ...
        <label>Blocked / maintenance message
          <textarea name="blocked_message" id="ad-mon-detail-blocked" rows="2" placeholder="Shown when the system is blocked"></textarea>
        </label>
        <label>Maintenance message
          <textarea name="maintenance_message" id="ad-mon-detail-message" rows="2" placeholder="Optional message shown on the installation"></textarea>
        </label>
    ...
    <section class="ad-card ad-page-section" id="ad-section-monitoring-overview" data-ad-page="monitoring-overview">
      <div class="ad-card-head">
        <div>
          <h2><i class="fa-solid fa-gauge-high"></i> Monitoring · Overview</h2>
          <p class="ad-period-sub">BOSS-PC-001 status, today’s searches, downloads and SMS</p>
        </div>
        <div class="ad-card-actions">
          <button type="button" class="ad-btn ad-btn--ghost" id="ad-mon-overview-refresh"><i class="fa-solid fa-rotate"></i><span>Refresh</span></button>
        </div>
      </div>
      <p id="ad-mon-overview-msg" class="ad-msg" hidden></p>
      <div class="ad-mon-cards" id="ad-mon-overview-cards"></div>
    </section>

    <section class="ad-card ad-page-section" id="ad-section-monitoring-searches" data-ad-page="monitoring-searches">
      <div class="ad-card-head">
        <div>
          <h2><i class="fa-solid fa-magnifying-glass"></i> Search Monitoring</h2>
          <p class="ad-period-sub">Every search from the boss installation, with real results</p>
        </div>
        <div class="ad-card-actions">
          <a class="ad-btn ad-btn--ghost" id="ad-mon-search-export" href="monitoring-admin-api.php?action=export-searches">Export CSV</a>
          <button type="button" class="ad-btn ad-btn--ghost" id="ad-mon-search-refresh"><i class="fa-solid fa-rotate"></i><span>Refresh</span></button>
        </div>
      </div>
      <form id="ad-mon-search-filters" class="ad-mon-filters" autocomplete="off">
        <label>Device <input type="text" id="ad-mon-s-device" value="BOSS-PC-001" /></label>
        <label>Username <input type="text" id="ad-mon-s-user" /></label>
        <label>Term <input type="text" id="ad-mon-s-term" /></label>
        <label>Status
          <select id="ad-mon-s-status">
            <option value="">All</option>
        ...
        <label>From <input type="date" id="ad-mon-s-from" /></label>
        <label>To <input type="date" id="ad-mon-s-to" /></label>
        <button type="submit" class="ad-btn ad-btn--primary"><i class="fa-solid fa-filter"></i><span>Filter</span></button>
      </form>
      <p id="ad-mon-search-msg" class="ad-msg" hidden></p>
      <div class="ad-mon-table-wrap">
        <table class="ad-mon-table" aria-label="Remote searches">
          <thead>
            <tr>
              <th>When</th>
              <th>Device</th>
          ...
          <tbody id="ad-mon-search-body"><tr><td colspan="7">Loading…</td></tr></tbody>
        </table>
      </div>
      <div class="ad-mon-pager" id="ad-mon-search-pager"></div>
      <h3 class="ad-mon-subtitle">Search results</h3>
      <p class="ad-mon-meta" id="ad-mon-results-meta">Select a search and click View Results.</p>
      <div class="ad-mon-table-wrap">
        <table class="ad-mon-table" aria-label="Search results">
          <thead>
            <tr>
              <th>Title</th>
              <th>Name</th>
          ...
          <tbody id="ad-mon-results-body"><tr><td colspan="6">—</td></tr></tbody>
        </table>
      </div>
    </section>

    <section class="ad-card ad-page-section" id="ad-section-monitoring-downloads" data-ad-page="monitoring-downloads">
      <div class="ad-card-head">
        <div>
          <h2><i class="fa-solid fa-download"></i> Download Monitoring</h2>
          <p class="ad-period-sub">File manifests and record lists (no binary files)</p>
        </div>
        <div class="ad-card-actions">
          <button type="button" class="ad-btn ad-btn--ghost" id="ad-mon-dl-refresh"><i class="fa-solid fa-rotate"></i><span>Refresh</span></button>
        </div>
      </div>
      <form id="ad-mon-dl-filters" class="ad-mon-filters" autocomplete="off">
        <label>Device <input type="text" id="ad-mon-dl-device" value="BOSS-PC-001" /></label>
        <label>Username <input type="text" id="ad-mon-dl-user" /></label>
        <label>Type <input type="text" id="ad-mon-dl-type" placeholder="csv / xlsx / pdf" /></label>
        <label>From <input type="date" id="ad-mon-dl-from" /></label>
        <label>To <input type="date" id="ad-mon-dl-to" /></label>
        <button type="submit" class="ad-btn ad-btn--primary"><i class="fa-solid fa-filter"></i><span>Filter</span></button>
      </form>
      <p id="ad-mon-dl-msg" class="ad-msg" hidden></p>
      <div class="ad-mon-table-wrap">
        <table class="ad-mon-table">
          <thead>
            <tr>
              <th>When</th>
              <th>File</th>
          ...
          <tbody id="ad-mon-dl-body"><tr><td colspan="7">Loading…</td></tr></tbody>
        </table>
      </div>
      <div class="ad-mon-pager" id="ad-mon-dl-pager"></div>
      <pre class="ad-mon-json" id="ad-mon-dl-records" hidden></pre>
    </section>

    <section class="ad-card ad-page-section" id="ad-section-monitoring-control" data-ad-page="monitoring-control">
      <div class="ad-card-head">
        <div>
          <h2><i class="fa-solid fa-sliders"></i> System Control</h2>
          <p class="ad-period-sub">Application modes only — no remote shell or file deletion</p>
        </div>
      </div>
      <p id="ad-mon-ctrl-msg" class="ad-msg" hidden></p>
      <form id="ad-mon-ctrl-form" class="ad-form ad-mon-detail-form" autocomplete="off">
        <input type="hidden" id="ad-mon-ctrl-csrf" />
        <div class="ad-mon-detail-grid">
          <label>Device
            <select id="ad-mon-ctrl-device"><option value="BOSS-PC-001">BOSS-PC-001</option></select>
          </label>
          <label>Control mode
            <select id="ad-mon-ctrl-mode">
              <option value="active">Activate System</option>
              <option value="read_only">Read-Only Mode</option>
              <option value="api_blocked">Block API/Search</option>
              <option value="fully_blocked">Fully Block System</option>
            </select>
          </label>
          <label>License expiry <input type="datetime-local" id="ad-mon-ctrl-expires" /></label>
          <label>Daily search limit <input type="number" id="ad-mon-ctrl-slimit" min="0" /></label>
          <label>Daily download limit <input type="number" id="ad-mon-ctrl-dlimit" min="0" /></label>
          <label class="ad-mon-check"><input type="checkbox" id="ad-mon-ctrl-maint" /> Maintenance mode</label>
          <label class="ad-mon-check"><input type="checkbox" id="ad-mon-ctrl-sms" /> SMS alerts ON</label>
        </div>
        <label>Custom block message
          <textarea id="ad-mon-ctrl-blocked" rows="3" placeholder="Shown after login when fully blocked"></textarea>
        </label>
        <p class="ad-mon-meta" id="ad-mon-ctrl-meta"></p>
        <button type="submit" class="ad-btn ad-btn--primary">Save control</button>
      </form>
      <h3 class="ad-mon-subtitle">Control audit</h3>
      <div class="ad-mon-table-wrap">
        <table class="ad-mon-table">
          <thead><tr><th>When</th><th>Field</th><th>From</th><th>To</th><th>Note</th></tr></thead>
          <tbody id="ad-mon-ctrl-audit"><tr><td colspan="5">—</td></tr></tbody>
        </table>
      </div>
    </section>

    <section class="ad-card ad-page-section" id="ad-section-monitoring-sms" data-ad-page="monitoring-sms">
      <div class="ad-card-head">
        <div>
          <h2><i class="fa-solid fa-comment-sms"></i> SMS Alerts</h2>
          <p class="ad-period-sub">One SMS per unique search. API key is never shown.</p>
        </div>
        <button type="button" class="ad-btn ad-btn--ghost" id="ad-mon-sms-refresh"><i class="fa-solid fa-rotate"></i><span>Refresh</span></button>
      </div>
      <p id="ad-mon-sms-msg" class="ad-msg" hidden></p>
      <form id="ad-mon-sms-form" class="ad-form ad-mon-detail-form">
        <input type="hidden" id="ad-mon-sms-csrf" />
        <div class="ad-mon-detail-grid">
          <label class="ad-mon-check"><input type="checkbox" id="ad-mon-sms-enabled" /> Enable alerts</label>
          <label>Recipient <input type="text" id="ad-mon-sms-recipient" /></label>
          <label>Mode
            <select id="ad-mon-sms-mode">
              <option value="per_search">One SMS per search</option>
              <option value="summary_5">Summary every 5 minutes</option>
              <option value="summary_10">Summary every 10 minutes</option>
            </select>
          </label>
        </div>
        <p class="ad-mon-meta" id="ad-mon-sms-meta"></p>
        <button type="submit" class="ad-btn ad-btn--primary">Save SMS settings</button>
      </form>
      <div class="ad-mon-table-wrap">
        <table class="ad-mon-table">
          <thead>
          ...
          <tbody id="ad-mon-sms-body"><tr><td colspan="6">Loading…</td></tr></tbody>
        </table>
      </div>
      <div class="ad-mon-pager" id="ad-mon-sms-pager"></div>
    </section>
