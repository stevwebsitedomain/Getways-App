...
function clickpesaEnvConfig(): array
{
    ...
    return [
        ...
        'defaultPayoutPhone' => $env('CLICKPESA_DEFAULT_PAYOUT_PHONE', 'CLICKPESA_AUTO_PAYOUT_PHONE', '255715296092'),
        ...
        'autoPayoutPhone' => $env('CLICKPESA_DEFAULT_PAYOUT_PHONE', 'CLICKPESA_AUTO_PAYOUT_PHONE', '255715296092'),
